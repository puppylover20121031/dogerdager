...
public final class SettingsScreen extends ScreenAdapter {
    ...
    private void handleKeys() {
        ...
        if (Gdx.input.isKeyJustPressed(Keys.W) || Gdx.input.isKeyJustPressed(Keys.UP)) index = (index + 3) % 4;
        if (Gdx.input.isKeyJustPressed(Keys.S) || Gdx.input.isKeyJustPressed(Keys.DOWN)) index = (index + 1) % 4;
