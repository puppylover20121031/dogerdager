...
public class BossArrow extends GameObject {// unused arrows that pops up when you press space.
  private final Handler handler;
    private GameObject player;
    private final float speed = 2.0f; // adjust to change follow speed
    private int timer = 80;

  public BossArrow(float f, float g, ID id, Handler handler1) {
    super(f, g, id);
